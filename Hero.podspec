Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/salamtime2016/Hero"
  s.screenshots      = "https://github.com/salamtime2016/Hero/blob/master/Resources/Hero.png?raw=true"
  s.license          = 'MIT'
  s.author           = { "Luke" => "lzhaoyilun@gmail.com" }
  s.source           = { :git => "https://github.com/salamtime2016/Hero.git", :tag => s.version.to_s }
